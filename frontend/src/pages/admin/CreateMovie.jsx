...
const CreateMovie = () => {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: "orange", minHeight: "100vh" }}
    >
      <div className="container flex justify-center items-center mt-4">
        <form>
          <p className="text-black-200 w-[50rem] text-2xl mb-4 pt-10">
            Create Movie
          </p>
          <div className="mb-4">
          ...
          <div className="mb-4">
            <label
              className={
                !selectedImage
                  ? "bg-green-500 rounded px-2 py-1 cursor-pointer"
          ...
          <button
            ...
            className="bg-green-500 px-4 py-2 rounded px-3 py-2 cursor-pointer"
