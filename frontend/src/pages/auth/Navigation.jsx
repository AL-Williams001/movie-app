...
const Navigation = () => {
  ...
  return (
    <div className="fixed bottom-10 left-[30rem] bg-teal-400 transform translate-x-1/2 translate-y-1/2 z-50 bg-[#0f0f0f] border w-[30%] px-[4rem] mb-[2rem] rounded">
      <section className="flex justify-between items-center">
        ...
        <div className="flex justify-center items-center mb-[2rem]">
          ...
          >
            <MdOutlineLocalMovies className="mr-2 mt-[3rem]" size={30} />
        ...
        <div className="relative">
          ...
          >
            {userInfo ? (
              <span className="text-blue">{userInfo.username}</span>
            ) : (
              <></>
            )}
          ...
          {!userInfo && (
            <ul className="flex">
              ...
              <li>
                ...
                >
                  <AiOutlineUserAdd className="mr-2 mt-4px" size={30} />
                  <span className="hidden nave-item-name">REGISTER</span>
                </Link>
              </li>
            </ul>
          )}
